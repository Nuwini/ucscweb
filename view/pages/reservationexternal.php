<html>
    ...
    <body>
		...
		$reservationfee = $_POST['reservationfee'];
                ...
                $sql = "INSERT INTO reservation (r_id,facility_id,r_date,purpose,start_time,end_time,user_id,v_nic,r_fee) VALUES ('$reservationid','$facilityid','$date','$purpose','$stime','$etime','$nic','$reservationfee')";
	    ...
	    <div class="form-group">
                 <label for="contactno" class="col-sm-4 control-label">Contact Number1</label>
                 <div class="col-sm-3">
	...
	<div class="form-group">
                 ...
                 <div class="col-sm-3">
                     <input class="form-control" type="text" name="contactno2">
                 </div>
            </div>
